...
public class TintProgressDialog extends AlertDialog implements Handler.Callback {
    ...
    public static magicasakura.widgets.TintProgressDialog show(Context context, CharSequence title,
    ...
    public static magicasakura.widgets.TintProgressDialog show(Context context, CharSequence title,
        ...
        magicasakura.widgets.TintProgressDialog dialog = new magicasakura.widgets.TintProgressDialog(context);
