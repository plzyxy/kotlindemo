package com.teayork.common_base.http.interceptor
...
class NetLogInterceptor @JvmOverloads constructor(lv: Level = Level.BODY, private val logger: (String) -> Unit = ::println) :
    Interceptor {
