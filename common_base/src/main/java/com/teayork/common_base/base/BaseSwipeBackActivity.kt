...
abstract class BaseSwipeBackActivity : BaseActivity(), BGASwipeBackHelper.Delegate {
    ...
    private fun initSwipeBackFinish() {
        ...
        mSwipeBackHelper.setIsOnlyTrackingLeftEdge(SPUtils.getBoolean(Constant.SLIDE_LEFT))
